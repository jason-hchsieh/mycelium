...
**Legend:**
- 🤖 Auto-trigger: Automatically applied when conditions met
- 📖 Manual: Invoke explicitly when needed
- ⭐ Generated: Created from learned patterns
- 🔧 Core: Built-in workflow skills
```
...
🤖 **TDD Enforcement**
   ...
   Enforces Iron Law TDD: Red → Green → Refactor.
...
**Generation Quality:**
- High confidence (≥5 occurrences): {count}
