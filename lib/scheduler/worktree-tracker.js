 ...
 *
 * @example
 * const worktrees = await getActiveWorktrees('.mycelium/state.json');
 */
 ...
 *
 * @example
 * const info = await getWorktreeInfo('.mycelium/state.json', '/path/to/worktree');
 */
 ...
 *
 * @example
 * const isActive = await isWorktreeActive('.mycelium/state.json', '/path/to/worktree');
 */
 ...
 *
 * @example
 * await trackWorktree('.mycelium/state.json', {
 ...
 *
 * @example
 * await untrackWorktree('.mycelium/state.json', '/path/to/worktree');
 */
 ...
 *
 * @example
 * const worktree = await getWorktreeForTrack('.mycelium/state.json', 'track-1');
 */
 ...
 *
 * @example
 * const stats = await getWorktreeStats('.mycelium/state.json');
